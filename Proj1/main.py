...
async def update(
    ...
    updated = crud.update_disciplina(db, infos, nome=nome_disciplina)
    if updated is None:
        raise HTTPException(status_code=404, detail="Já existe uma disciplina com esse nome")
    else:
        return updated
...
response_model=List[schemas.Nota],
tags=["notas"]
)
